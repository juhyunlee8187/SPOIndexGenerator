...
namespace ChatWithSPODocuments.Helpers
{
    ...
    public class GraphUsingHttp
    {
        ...
        public async Task<dynamic?> GetSPOFilesAsync(string siteId, string driveId, string authToken)
        {
            try
            {
                // string spoGraphUrl = $"https://graph.microsoft.com/v1.0/sites/{siteId}/drive/root/children";
                string spoGraphUrl = $"https://graph.microsoft.com/v1.0/drives/{driveId}/root/children";
